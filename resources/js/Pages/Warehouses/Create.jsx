...
export default function WarehousesCreate() {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="heading-md text-ink">{t('pages.warehouses.create_title')}</h2>}>
            <Head title={t('pages.warehouses.create_title')} />

            <PageHeader
                title={t('pages.warehouses.create_title')}
                actions={
                    <BackButton href={route('warehouses.index')}>
                        {t('common.back')}
                    </BackButton>
                }
            />
