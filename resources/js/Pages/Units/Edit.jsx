...
export default function UnitsEdit({ unit }) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="heading-md text-ink">{t('pages.units.edit_title')}</h2>}>
            <Head title={t('pages.units.edit_title')} />
