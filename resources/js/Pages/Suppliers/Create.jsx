...
export default function SuppliersCreate() {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="heading-md text-ink">{t('pages.suppliers.create_title')}</h2>}>
            <Head title={t('pages.suppliers.create_title')} />

            <PageHeader
                title={t('pages.suppliers.create_title')}
                actions={
