...
const icon = (paths) =>
    function FormIcon({ className = base.className, ...props }) {
        return (
...
export const IconBarcode = icon(
    <path strokeLinecap="round" d="M4 5v14M7.5 5v8M11 5v14M14.5 5v6M18 5v14M21 5v9" />,
);
...
export const IconHashtag = icon(
    <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 8.25h15m-16.5 7.5h15m-1.8-13.5l-3.9 19.5m-6.6 0l-3.9-19.5" />,
);

export const IconNumber = icon(
    <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M7.5 8.25h9m-9 3H12m-2.25-5.25h4.5m-6.75 15h.008v.008h-.008v-.008zm.75 0h.008v.008h-.008v-.008zm3.75 0h.008v.008h-.008v-.008zm.75 0h.008v.008h-.008v-.008zm2.25 0h.008v.008h-.008v-.008zm.75 0h.008v.008h-.008v-.008zm3 0h.008v.008h-.008v-.008zm.75 0h.008v.008h-.008v-.008z"
    />,
);
...
export const IconPercent = icon(
    <>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 18a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
    </>,
);
